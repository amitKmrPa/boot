...
public interface OrdersRepo extends JpaRepository<Order , Integer>  {
    ...
    @Query(value="select u.quantity,v.product_name,v.price,v.product_Id,v.product_type,u.order_id from product_orders u inner join products_data v on u.product_Id=v.product_Id where u.order_id=?1",nativeQuery = true)
